...
> [!IMPORTANT]
> **The Strict Equatorial Regularity Constraint**:
> To satisfy Axiom 2 ($\le 2$ polygon types), the equatorial base facets of studded cylindrical and prismatic phyla **must be strictly regular polygons**:
> - **Prisms & Elongated Bipyramids**: Lateral quadrilaterals must be **strictly regular squares** ($h = s = 2r\sin(\pi/n)$). If they were non-square rectangles ($h \ne s$), erecting a central pyramid would divide each face into *two distinct non-congruent pairs of triangles* (top/bottom with base $s$, and left/right with base $h$), instantly generating 3+ polygon types and violating the Sieve.
> - **Antiprisms**: Lateral triangular faces must be **strictly equilateral triangles**, ensuring all 3 sub-triangles per stud are mutually congruent.
> - **Studded Gyroelongated Bipyramids (Disqualified)**: In a gyroelongated bipyramid, the polar triangles and equatorial antiprismatic triangles are geometrically distinct. Studding both creates two distinct species of stud triangles, exceeding the 2-polygon limit and **disqualifying** the general family.
...
| :--- | :---: | :--- | :--- | :--- | :--- |
| **Equatorially Studded Prisms** | <img src="img/cookson/excluded/phyla/heptagonal_equatorially_studded_prism.png" width="90" alt="Equatorially Studded Prism"> | An $n$-gonal uniform prism whose $n$ regular square lateral faces are studded with 4-sided pyramids. | Exactly 2 types:<br>• 2 $n$-gons<br>• $4n$ congruent triangles | All $2n + n$ vertices normalize onto the circumscribed sphere. | Infinite family of augmented prisms. |
| **Equatorially Studded Antiprisms** | <img src="img/cookson/excluded/phyla/heptagonal_equatorially_studded_antiprism.png" width="90" alt="Equatorially Studded Antiprism"> | An $n$-gonal uniform antiprism whose $2n$ equilateral lateral faces are studded with 3-sided pyramids. | Exactly 2 types:<br>• 2 $n$-gons<br>• $6n$ congruent triangles | All $2n + 2n$ vertices normalize onto the circumscribed sphere. | Infinite family of augmented antiprisms. |
| **Equatorially Studded Elongated Bipyramids** | <img src="img/cookson/excluded/phyla/heptagonal_equatorially_studded_elongated_bipyramid.png" width="90" alt="Equatorially Studded Elongated Bipyramid"> | An $n$-gonal bipyramid with an inserted uniform square prismatic band whose lateral squares are studded into pyramids. | Exactly 2 types:<br>• $2n$ polar triangles<br>• $4n$ equatorial triangles | All $2n + 2 + n$ vertices normalize symmetrically onto the unit sphere. | Infinite family of elongated bipyramid derivatives. |
