...
# Core mathematical types & operations
include("core/types.jl")
include("core/geometrytools.jl")
include("core/convexhull.jl")
include("core/operations.jl")

# 2D Polygons, Polygrams & Star Shapes
include("polygons/polygons.jl")

# Polyhedral Families
include("families/prisms.jl")
include("families/platonic.jl")
include("families/archimedean.jl")
include("families/keplerpoinsot.jl")
include("families/catalan.jl")
include("families/cookson.jl")
include("families/johnson.jl")
include("families/geodesic.jl")

# I/O, Printing & Visualization
...
# Geodesic Spheres (Triangular) & Goldberg Solids (Dual Pentagonal/Hexagonal)
export geodesic_sphere, geodesic_icosahedron, geodesic_polyhedron
export goldberg_solid, goldberg_polyhedron, fullerene, buckyball
